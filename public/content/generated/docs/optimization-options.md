...
- Production bundle demo isolation: review whether local demo fixture code can be excluded from production JavaScript while keeping `pnpm dev` zero-config. Impact: improves bundle clarity and reduces shipped fixture surface. Uncertainty/research: needs current Next.js bundling and synchronous Supabase client initialization constraints before changing module boundaries.
