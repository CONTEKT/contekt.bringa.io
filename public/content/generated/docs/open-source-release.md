...
- local backend mode: `pnpm exec supabase start` plus `pnpm seed:local-supabase` covers schema, RLS, RPC, Auth, Storage, and Edge Function work without consuming hosted Supabase quota;
