...
export default function TopBar() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50 border-b bg-background">
            <Menubar className="w-full h-12 px-4 md:px-8 border-none">
                    ...
                    <div className="flex items-center gap-2">
                        {isAdmin && (
                            <Link href="/admin/dashboard">
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-md hover:bg-accent transition-colors cursor-pointer whitespace-nowrap">
