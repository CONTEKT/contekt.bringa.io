...
const requiredPhrases = [
  ...
  "GitHub branch protection remains the only open repository-settings blocker.",
  "Repository visibility, forkability, merge method, branch cleanup, repository description, topics, Pages source, custom domain, DNS, certificate approval, and HTTPS enforcement are confirmed",
