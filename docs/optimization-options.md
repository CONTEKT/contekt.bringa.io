...
- Admin item control: build on the implemented per-user item review route with hide/unhide reason flows and restore visibility through moderation state. Impact: operator efficiency. Side effect: must avoid bypassing ownership/version rules.
