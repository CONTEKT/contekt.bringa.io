...
- CI foundation: secret-free GitHub Actions checks are present and include full lint; next steps are branch protection, docs build, and lint-warning cleanup.
