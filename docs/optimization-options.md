...
- Admin item control: extend the implemented per-user item review route with direct visibility controls that reuse the `set_item_visibility` reason flow. Impact: operator efficiency. Side effect: must avoid bypassing ownership/version rules.
