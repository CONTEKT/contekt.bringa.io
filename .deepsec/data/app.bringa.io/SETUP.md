# Agent setup for `app.bringa.io`

This is a deepsec scanning workspace. Project `app.bringa.io` was just registered
(target: `..`). Setup is incomplete — `data/app.bringa.io/INFO.md`
...
2. **Fill in `data/app.bringa.io/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id app.bringa.io
pnpm deepsec process --project-id app.bringa.io
```
